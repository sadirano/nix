...
pub const specs = [_]Spec{
    ...
    .{
        ...
        \\their cached results), exports.toml (what --sync-bin installed), bin/
        \\(the command wrappers plus [bin] exports, on PATH), and AGENTS.md -
        \\this guide's short form, regenerated by --sync.
        \\
